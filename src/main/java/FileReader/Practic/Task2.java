 ...
 * для которых последняя буква одного слова совпадает с первой буквой
 * следующего слова
*/
public class Task2 {
    public static void main(String[] args) throws IOException {
        ...
        try (Scanner scanner = new Scanner(path)) {
            ...
            while (scanner.hasNext()){
                ...
                if (isEqLastFerstSymbol(prev,current)){
    ...
    private static boolean isEqLastFerstSymbol(String prev, String current) {
